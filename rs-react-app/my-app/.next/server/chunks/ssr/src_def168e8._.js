module.exports = {
  ...
  '[project]/src/components/ResultsSection/ResultsSection.module.scss.module.css [app-ssr] (css module)':
    (__turbopack_context__) => {
      __turbopack_context__.v({
        ...
        loaderContainer:
          'ResultsSection-module-scss-module__3xws1W__loaderContainer',
        ...
        paginationButton:
          'ResultsSection-module-scss-module__3xws1W__paginationButton',
        paginationInfo:
          'ResultsSection-module-scss-module__3xws1W__paginationInfo',
        resultsSection:
          'ResultsSection-module-scss-module__3xws1W__resultsSection',
        resultsSectionError:
          'ResultsSection-module-scss-module__3xws1W__resultsSectionError',
      });
    },
  ...
  '[project]/src/pages/home/Home.tsx [app-ssr] (ecmascript)': (
    ...
    const Home = () => {
      ...
      const mainPanelRef = (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        'useRef'
      ])(null);
      const performNavigation = (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        'useCallback'
      ])(
        (path) => {
      ...
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        ...
        (searchResults, searchTerm, pages) => {
          ...
          if (searchTerm !== query) {
            ...
            performNavigation(
              `/characters/1${params.toString() ? `?${params.toString()}` : ''}`
            );
          }
        },
        [query, searchParams, performNavigation]
      );
      ...
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        ...
        (cardId) => {
          ...
          performNavigation(
            `/character/${currentPage}/${cardId}${params.toString() ? `?${params.toString()}` : ''}`
          );
        },
        [currentPage, query, searchParams, performNavigation]
      );
      ...
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        ...
        (newPage) => {
          ...
          performNavigation(
            `/characters/${newPage}${params.toString() ? `?${params.toString()}` : ''}`
          );
        },
        [totalPages, query, searchParams, performNavigation]
      );
      return /*#__PURE__*/ (0,
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[
        'jsxDEV'
...
//# sourceMappingURL=src_def168e8._.js.map
