...
function SearchSection({ onSearchResults, onLoadingChange, onErrorChange, currentPage, setCurrentPage }) {
    ...
    const handleSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$debounce$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDebouncedCallback"])((term, isPageChange = false)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        onSearchResults(data ? data.data || null : null, searchTerm, data?.info?.pages || 1);
    }, [
        data,
        inputValue,
        onSearchResults
...
function c(e, u, c, i) {
    ...
    var T = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(function() {
        ...
        return W.cancel = function() {
            v.current && (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : clearTimeout(v.current)), f.current = 0, m.current = o.current = d.current = v.current = null;
