          ...
          function onCaughtError(thrownValue, errorInfo) {
            ...
            if (('TURBOPACK compile-time truthy', 1)) {
              ...
              const componentThatErroredFrame =
                errorInfo == null
                  ? void 0
                  : (_errorInfo_componentStack = errorInfo.componentStack) ==
                      null
                    ? void 0
              ...
              const matches =
                (_componentThatErroredFrame_match =
                  componentThatErroredFrame == null
                    ? void 0
                    : componentThatErroredFrame.match(
                        /\s+at (\w+)\s+|(\w+)@/
                      )) != null
                  ? _componentThatErroredFrame_match
                  : [];
              const componentThatErroredName =
                matches[1] || matches[2] || 'Unknown';
              ...
              const error = devToolErrorMod.decorateDevError(
                thrownValue,
                errorInfo
              );
...
*/ Object.defineProperty(exports, '__esModule', {
        ...
        var { m: module, e: exports } = __turbopack_context__;
        {
          ...
          function getExistingCacheEntry(
            ...
            for (const maybeNextUrl of [nextUrl, null]) {
              ...
              const entryWithoutParams = prefetchCache.get(
                cacheKeyWithoutParams
              );
              if (
                ('TURBOPACK compile-time value', 'development') !==
    ...
    '[project]/node_modules/next/dist/client/components/http-access-fallback/error-boundary.js [app-client] (ecmascript)':
      (__turbopack_context__) => {
        ...
        var { m: module, e: exports } = __turbopack_context__;
        {
          ...
          class HTTPAccessFallbackErrorBoundary extends _react.default
            .Component {
            componentDidCatch() {
              if (
                ('TURBOPACK compile-time value', 'development') ===
            ...
            render() {
              const { notFound, forbidden, unauthorized, children } =
                this.props;
    ...
    '[project]/node_modules/next/dist/client/dev/hot-reloader/app/use-websocket.js [app-client] (ecmascript)':
      (__turbopack_context__) => {
        'use strict';
      ...
      (__turbopack_context__) => {
        ...
        var { m: module, e: exports } = __turbopack_context__;
        {
          ...
          const _nextdevtools = __turbopack_context__.r(
            '[project]/node_modules/next/dist/compiled/next-devtools/index.js [app-client] (ecmascript)'
          );
          ...
          const _useforwardconsolelog = __turbopack_context__.r(
            '[project]/node_modules/next/dist/next-devtools/userspace/app/errors/use-forward-console-log.js [app-client] (ecmascript)'
          );
        ...
        var { m: module, e: exports } = __turbopack_context__;
        {
          ...
          function handleAliasedPrefetchEntry(
            ...
            for (const normalizedFlightData of flightData) {
              ...
              if (
                !hasLoadingComponentInSeedData(normalizedFlightData.seedData)
              ) {
                continue;
              }
            ...
            for (const key in routerState[1]) {
              ...
              if (parallelSeedData !== null) {
                ...
                newCacheNode = {
                  ...
                  rsc: segmentForParallelRoute.includes(
          ...
          function hmrRefreshReducerImpl(state, action) {
            ...
            return cache.lazyData.then(
              (param) => {
                ...
                let currentCache = state.cache;
                for (const normalizedFlightData of flightData) {
                  const { tree: treePatch, isRootRender } =
                    normalizedFlightData;
                  if (!isRootRender) {
                    // TODO-APP: handle this case better
                    console.log('REFRESH FAILED');
            ...
            replace: (href, options) => {
              (0, _react.startTransition)(() => {
                ...
                dispatchNavigateAction(
                  ...
                  'replace',
                  (_options_scroll =
                    options == null ? void 0 : options.scroll) != null
                    ? _options_scroll
                    : true,
                  null
                );
      ...
      (__turbopack_context__) => {
        ...
        var { m: module, e: exports } = __turbopack_context__;
        {
          ...
          function createInitialRouterState(param) {
            ...
            _flightdatahelpers.getFlightDataPartsFromPath)(
              initialFlightData[0]
            );
            const {
              tree: initialTree,
                  ...
                  if (mutation.type === 'childList') {
                    for (const node of mutation.addedNodes) {
                      if ('tagName' in node && node.tagName === 'LINK') {
                        ...
                        const link = node;
                        if (
                          (_link_dataset_precedence =
                            link.dataset.precedence) == null
                            ? void 0
                              ...
                              for (const otherLink of allLinks) {
                                ...
                                if (
                                  (_otherLink_dataset_precedence =
                                    ...
                                    ? void 0
                                    : _otherLink_dataset_precedence.startsWith(
                                        'next'
                                      )
                                ) {
                                  const otherHref =
                                    otherLink.getAttribute('href');
                                  if (otherHref) {
      ...
      (__turbopack_context__) => {
        ...
        var { m: module, e: exports } = __turbopack_context__;
        {
          ...
          function nextServerDataRegisterWriter(ctr) {
            if (initialServerDataBuffer) {
              initialServerDataBuffer.forEach((val) => {
                ctr.enqueue(
                  typeof val === 'string' ? encoder.encode(val) : val
                );
              });
          ...
          function ServerRoot(param) {
            ...
            const router = /*#__PURE__*/ (0, _jsxruntime.jsx)(
              _approuter.default,
              {
                gracefullyDegrade: (0, _isbot.isBot)(
          ...
          function hydrate(instrumentationHooks) {
            ...
            const reactEl = /*#__PURE__*/ (0, _jsxruntime.jsx)(
              StrictModeIfEnabled,
              {
                children: /*#__PURE__*/ (0, _jsxruntime.jsx)(
